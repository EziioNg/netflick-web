      ...
      <div className="account-body">
        <div className="body-section">
          <div className="flex flex-col mb-6">
            <label
              className="inline-block mb-2 text-xs text-static-grey-9"
              htmlFor=""
            >
              Email
            </label>
          ...
          <div className="block mb-12">
            <label className="block mb-4 text-xs text-static-grey-9" htmlFor="">
              Gender
            </label>
          ...
          <div className="relative w-[120px] h-[120px] border-2 shrink-0 overflow-hidden bg-background-user-black rounded-search cursor-pointer">
            <img
              ...
              src={
                preview ||
                currentUser?.avatar ||
                "https://res.cloudinary.com/doam999z1/image/upload/v1752230418/3vjpg_aemnc5.jpg"
              }
              alt="avatar"
            />
          </div>
