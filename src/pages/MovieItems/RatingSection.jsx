      ...
      <div className="relative w-full h-[199.2px] what-on-mask group/scroll">
        ...
        >
          {mockRatings.map((item, idx) => (
            ...
            >
              <div className="inline-flex m-auto p-4 overflow-hidden rounded-lg cursor-pointer w-[288px] h-[172px] bg-background-card hover:shadow-[0_0_0_2px_white]">
                <div className="flex flex-col grow shrink flex-nowrap items-start gap-3">
                  <div className="flex flex-row grow-0 shrink flex-nowrap items-center gap-4">
                    <img className="max-w-12" src={item.symbol} alt="symbol" />
                  ...
                  <span className="max-w-full h-[80px] text-ellipsis overflow-hidden line-clamp-4 text-sm font-normal">
                    {item.battleCry}
                  </span>
                </div>
              </div>
        ...
        {selectedItem && (
          <Modal1 onClose={() => setSelectedItem(null)}>
            <div className="flex flex-col grow shrink flex-nowrap items-start gap-6">
              ...
              <span className="max-w-full whitespace-pre-line overflow-auto text-sm font-normal text-text-default">
