...
const Watch = () => {
  ...
  if (loading)
    return (
      <div className="text-white px-4 items-center justify-self-center text-6xl">
        Loading...
      </div>
    );
      ...
      <div className="mv-upper">
        <div className="flex flex-row flex-nowrap items-center justify-between h-12 pl-4">
          <div className="flex flex-row flex-nowrap grow-0 shrink items-center h-full gap-6">
            ...
            />
            <span className="grow-0 shrink overflow-hidden text-base font-normal text-text-default">
              {movie.title}
            </span>
          </div>
          <div className="flex flex-row flex-nowrap grow-0 shrink">
            <div className="mv-watch-share-icon rounded-search">
              <a
                ...
                className="flex flex-row flex-nowrap grow-0 shrink items-center justify-center"
              >
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex flex-row grow-0 shrink-0 justify-start w-[33.33%]">
              <div className="flex items-center gap-1">
                <span
                  className="mb-bar-item-medium rounded-search"
                  onClick={toggleMute}
                >
                  {isMuted ? (
            ...
            <div className="flex flex-row grow-0 shrink-0 justify-center w-[33.33%]">
              <button
                onClick={togglePlay}
                className="mb-bar-item-large rounded-search"
              >
                {isPlaying ? (
