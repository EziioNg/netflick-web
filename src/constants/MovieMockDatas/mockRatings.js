...
const mockRatings = [
    {
        ...
        battleCry: "The measure of true glory is not to give battle in the bright noon of war, surrounded by brave comrades upon the field of victory, but to valiantly fight on alone in the darkness, with no hope of aid or even remembrance, and to spit defiance in midnight's eye."
    },
    {
        id: 2,
        name: "Helbrecht",
        ...
        battleCry: "The galaxy is the Emperor's, and anyone or anything who challenges that claim is an enemy who must be destroyed."
    },
    {
        id: 3,
        name: "Marneus Calgar",
        ...
        battleCry: "We are the Ultramarines, the sons of Guilliman. Whilst we draw breath, we stand. Whilst we stand, we fight. Whilst we fight, we prevail. Nothing shall stay our wrath."
    },
    {
        id: 4,
        name: "Sa'Kan",
        ...
        battleCry: "On the Anvil of War are the strong tempered and the weak made to perish, thus are men's souls tested as metal in the forge's fire."
    },
    {
        id: 5,
        name: "Kayvaan Shrike",
    ...
    },
    {
        ...
        battleCry: "I was never a Son of Horus. I was and remain a Luna Wolf. A proud son of Cthonia, a loyal servant of the Emperor, beloved by all. I am your enemy."
    },
    {
        id: 7,
        name: "Luis Dante",
    ...
    },
    {
        ...
        battleCry: "The Sons of Fenris they are, hardened in the forge of their harsh world, eager for battle and honour. They are the grey warriors, ashen like the wolf, whose greatest joy is to hear the clamour of steel amidst the din of war."
    },
    {
        id: 9,
        name: "Jubal Khan",
    ...
    },
    {
        ...
        battleCry: "We are the warriors of the Grey Knights, armoured in faith, shielded by devotion and armed with purity of purpose. But greater even than these, we carry the light of the divine Emperor of Mankind into the dark places to purge the Daemonic wherever it may be found."
    },
    {
        id: 13,
        ...
        battleCry: "There is no truth in flesh, only betrayal.\n" +
